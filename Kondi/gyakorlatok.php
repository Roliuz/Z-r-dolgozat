        ...
        <div class="row">
            <div class="card border border-0 text-white mt-4 mb-3">
                ...
                <a href="mellizom.php" target="_blank">
                    <div class="kartyahatter"><img src="../Pic/mellizom.jpg" class="card-img img-fluid " alt="..."></div>
        ...
        <div class="row">
            <div class="card border border-0 text-white mt-4 mb-3">
                <a href="bicepsz.php" target="_blank">
                    <div class="kartyahatter"><img src="../Pic/bicepsz.jpg" class="card-img img-fluid " alt="..."></div>
                    <div class="card-img-overlay">
